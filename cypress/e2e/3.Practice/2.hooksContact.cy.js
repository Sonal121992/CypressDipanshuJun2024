...
// Since here we are using hooks to visit url therefore we will not use cy.visit again and again
// as the before each function will execute before every it block
